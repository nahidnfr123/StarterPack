      ...
      <Container>
        <div class="flex items-center justify-between py-6 md:justify-start md:space-x-10">
          ...
          <div class="hidden items-center justify-end md:flex md:flex-1 lg:w-0">
            ...
            <!--            <NuxtLink
                            to="/auth/login"
                            class="inline-flex items-center justify-center whitespace-nowrap rounded-full bg-primary-color px-5 py-2 text-base font-medium text-white shadow-sm hover:bg-indigo-600 duration-500"
                        >
                          Login
                        </NuxtLink>-->
...
const navigationLinks = [
  ...
  {title: 'Courses', link: '/courses', icon: "fa6-solid:graduation-cap"},
  {title: 'E-Books', link: '/e-books', icon: 'fa6-solid:book-open-reader'},
  {title: 'Blogs', link: '/blogs'},
  {title: 'Notice', link: '/notices'},
