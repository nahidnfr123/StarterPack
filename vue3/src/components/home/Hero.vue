<template>
  <div class="isolate bg-white z-0">
        ...
        <div class="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
          <div class="hidden sm:mb-8 sm:flex sm:justify-center">
            <div class="relative rounded-full py-1 px-3 text-sm leading-6 text-gray-600 ring-1 ring-gray-900/10 hover:ring-gray-900/20">
              Starter Projects
              <a href="https://github.com/nahidnfr123/StarterPack"
                 target="_blank"
          ...
          <div class="text-center">
            <h1 class="text-4xl font-bold tracking-tight text-gray-900 sm:text-6xl">Vue3 Starter Project</h1>
            <p class="mt-6 text-lg leading-8 text-gray-600">Vue3 + FormKit + Pinia + Laravel9+10 starter project with user authentication, email verification, password reset and profile update.</p>
